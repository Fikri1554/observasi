    ...
    $(document).ready(function() {
        $("#saveEditDetail").click(function(e) {
            ...
            $("#idFieldEditDetail .row").each(function() {
                formData.txtdescription.push($(this).find(
                        "input[name^='txtdescription[]']")
                    .val());
                formData.txttype.push($(this).find("input[name^='txttype[]']")
                    .val());
                formData.txtreason.push($(this).find(
                    "input[name^='txtreason[]']").val());
                formData.txtquantity.push($(this).find(
                    "input[name^='txtquantity[]']").val());
                formData.txtnote.push($(this).find("input[name^='txtnote[]']")
                    .val());
                formData.txtIdDetail.push($(this).find(
                    "input[name='txtIdDetail[]']").val());
            });
            $.ajax({
