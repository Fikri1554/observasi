				...
				<tr>
					<td style="width:250px;vertical-align:top;">
						<table style="width:100%" cellspacing="0">
							...
							<tr>
								<td style="width:120px;">Demmurage</td>
								<td style="width:130px;border-left:1px;border-right:1px;border-bottom:1px;border-style:solid;"><?php echo strtoupper($data[0]->demmurage_curr)." ".number_format($data[0]->demmurage,0); ?> PDPR</td>
							</tr>
							<tr>
								<td style="width:120px;">Despatch</td>
								<td style="width:130px;border-left:1px;border-right:1px;border-bottom:1px;border-style:solid;"><?php echo strtoupper($data[0]->despatch_curr)." ".number_format($data[0]->despatch,0); ?> PDPR</td>
							</tr>
						</table>
					</td>
					<td style="width:250px;vertical-align:top;">
