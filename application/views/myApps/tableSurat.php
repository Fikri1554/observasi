    ...
    <section id="container">
        <section id="main-content">
            <section class="wrapper site-min-height" style="min-height:400px;">
                <h3>
                    <i class="fa fa-angle-right"></i> Surat<span style="padding-left:20px;display:none;"
                ...
                <div class="form-panel" id="idDataTable">
                    <div class="row">
                        ...
                        <div class="col-md-2" style="margin-top:5px;">
                            <input type="text" class="form-control input-sm" id="txtDateStartSearch" value=""
                                placeholder="Start Date">
                        </div>
                        <div class="col-md-2" style="margin-top:5px;">
                            <input type="text" class="form-control input-sm" id="txtDateEndSearch" value=""
                                    ...
                                    <thead>
                                        <tr style="background-color: #ba5500;color: #FFF;">
                                            <th rowspan="2"
                                                ...
                                                No</th>
                                            <th rowspan="2"
                                                style="vertical-align: middle; width:20%;text-align:center;">Perusahaan
                                            </th>
                                            <th rowspan="2"
                                                style="vertical-align: middle; width:10%;text-align:center;">Tgl. Surat
                                            </th>
                                            <th rowspan="2"
                                                style="vertical-align: middle; width:15%;text-align:center;">No. Surat
                                            </th>
                                            <th rowspan="2"
                                                style="vertical-align: middle; width:20%;text-align:center;">Alamat
                                                Penerima</th>
                                            <th rowspan="2"
                                                style="vertical-align: middle; width:20%;text-align:center;">Keterangan
                                            </th>
                                            <th rowspan="2"
                                                style="vertical-align: middle; width:20%;text-align:center;">Pembuat
                                            </th>
                                            <th colspan="3"
                                                style="vertical-align: middle; width:20%;text-align:center;">Action</th>
                                        </tr>
                                        <tr style="background-color: #ba5500;color: #FFF;">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-xs-12">
                                <legend>
                                    ...
                                    <img id="idLoadingAdd" src="<?php echo base_url('assets/img/loading.gif'); ?>"
                            ...
                            <div class="col-md-2 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control input-sm" id="txtTanggal" value=""
                                        placeholder="Tanggal">
                                </div>
                            </div>
                            <div class="col-md-2 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" disabled="disabled" class="form-control input-sm" id="txtNoSurat"
                                        value="" placeholder="No Surat">
                                </div>
                            </div>
                            <div class="col-md-2 col-xs-12">
                                <div class="form-group">
                            ...
                            <div class="col-md-3 col-xs-12">
                                <div class="form-group">
                                    <label for="txtKeterangan"><b><u>Keterangan :</u></b></label>&nbsp<label
                                        id="lblLimitChar" style="color:red;font-style:italic;"></label>
                                    <textarea class="form-control input-sm" id="txtKeterangan"
                                        oninput="hitungLimitCharKet();"></textarea>
                                </div>
                            </div>
                            <div class="col-md-2 col-xs-12">
                                <div class="form-group">
                                    <label for="txtPembuat"><b><u>Pembuat No. Surat :</u></b></label>
                                    <input type="text" class="form-control input-sm" id="txtPembuat"
                                        value="<?php echo $fullNameLogin; ?>" placeholder="Pembuat">
                                </div>
                            </div>
                            <div class="col-md-2 col-xs-12">
                                <div class="checkbox">
