	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$("#btnSave").click(function(){
				...
				var fileUploadNya = "";
		        var cekFile = $("#fileSurat").val();

		        if(cekFile != "")
		        {
		          fileUploadNya = $("#fileSurat").prop('files')[0];
		        }
				...
				formData.append('diKeluarkan',diKeluarkan);
				formData.append('diTandaTangani',diTandaTangani);
				formData.append('alamat',alamat);
				formData.append('keterangan',keterangan);
				formData.append('pembuatSurat',pembuatSurat);
				formData.append('copy',copy);
				formData.append('batal',batal);
				...
				$.ajax("<?php echo base_url('myLetter/addUpdateData'); ?>",{
		          method: "POST",
		          data: formData,
		          cache: false,
		          contentType: false,
				...
				<div id="idForm" style="display:none;">
					<div class="form-panel">
						<div class="row">
							...
							<div class="col-md-3 col-xs-12">
								<label for="fileSurat"><b><u>File Upload :</u></b></label>
								<input type="file" id="fileSurat" class="form-control input-sm" value="">
							</div>
							<div class="col-md-1 col-xs-12">
								<label>&nbsp</label>
								<button id="btnClearFile" onclick="$('#fileSurat').val('');" class="btn btn-warning btn-xs btn-block" title="Clear">Clear</button>
							</div>
						</div>
					</div>
					<div class="form-panel">
